...
async function createProperties() {
  const properties = [
    ...
    //NEW
    {
      ...
      description:
        "Compact and stylish studio with built-in storage and modern amenities.",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      id: 22,
      creatorId: 2,
      title: "Spacious 2 Room Apartment",
      description:
        "Well-lit 2 room apartment with balcony and open kitchen. Recently renovated",
      numberOfRooms: 2,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: true,
    ...
    },
    {
      ...
      description:
        "Affordable studio near university district, perfect for students.",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.54,
      latitude: 50.57,
      availableFrom: "2024-12-25T00:00:00Z",
    ...
    },
    {
      ...
      description: "Exclusive penthouse studio with stunning skyline views.",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: true,
    ...
    },
    {
      ...
      description: "Cozy one-bedroom apartment at an unbeatable price.",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      id: 26,
      creatorId: 1,
      title: "Family-Friendly 3 Room Apartment",
      description:
        "Spacious 3-room apartment with garden access. Ideal for families",
      numberOfRooms: 3,
      numberOfBeds: 2,
      numberOfBaths: 1,
      pets: true,
      ...
      longitude: 9.68,
      latitude: 50.52,
      availableFrom: "2025-02-10T00:00:00Z",
    ...
    },
    {
      id: 27,
      creatorId: 2,
      title: "High-End Studio with Smart Home Features",
      description:
        "Modern studio equipped with smart home system and fast internet. Smart home technology",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      id: 28,
      creatorId: 3,
      title: "Minimalist 2 Room Apartment",
      description:
        "Sleek, minimalist apartment with great lighting and space. Modern minimalist design",
      numberOfRooms: 2,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.67,
      latitude: 50.51,
      availableFrom: "2025-02-05T00:00:00Z",
    ...
    },
    {
      ...
      description:
        "Well-designed studio with large windows and city views. Great location near transport",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      id: 30,
      creatorId: 3,
      title: "Luxury 4 Room Apartment",
      description:
        "Spacious and high-end apartment in a prime location. Luxury living space",
      numberOfRooms: 4,
      numberOfBeds: 3,
      numberOfBaths: 2,
      pets: true,
      ...
      longitude: 9.71,
      latitude: 50.56,
      availableFrom: "2025-04-01T00:00:00Z",
      createdAt: "2024-10-30T00:00:00Z",
      updatedAt: "2024-10-30T00:00:00Z",
      status: "ACTIVE",
      propertyType: "APARTMENT",
      adminComment: "Luxury living space",
    },
    {
      id: 31,
      creatorId: 1,
      ...
      description:
        "A sleek and modern studio with open floor plan. Recently upgraded kitchen",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      ...
      description:
        "A budget-friendly apartment with spacious living area. Ideal for young professionals",
      numberOfRooms: 2,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: true,
    ...
    },
    {
      ...
      description:
        "A high-end studio with integrated smart home features. Voice-controlled lighting and heating",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.71,
      latitude: 50.5,
      availableFrom: "2025-02-20T00:00:00Z",
    ...
    },
    {
      ...
      description:
        "A charming apartment with wooden floors and a small balcony. Quiet neighborhood",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      id: 35,
      creatorId: 2,
      title: "Bright Studio with Garden Access",
      description:
        "A unique studio with direct access to a shared garden. Great for plant lovers",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: true,
    ...
    },
    {
      ...
      description:
        "A family-friendly apartment with ample storage and natural light. Includes underground parking",
      numberOfRooms: 3,
      numberOfBeds: 2,
      numberOfBaths: 1,
      pets: true,
      ...
      longitude: 9.75,
      latitude: 50.46,
      availableFrom: "2025-03-10T00:00:00Z",
    ...
    },
    {
      ...
      description:
        "A small but well-designed studio with a cozy balcony. Perfect for singles",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      ...
      description:
        "A stylish and compact studio in a high-rise. Great view from the 10th floor",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      ...
      description:
        "A warm and inviting 2-room apartment with wooden floors. Recently painted",
      numberOfRooms: 2,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: true,
      ...
      longitude: 9.63,
      latitude: 50.5,
      availableFrom: "2025-01-12T00:00:00.000Z",
    ...
    },
    {
      ...
      description:
        "A compact yet modern studio with easy access to public transport. Good for commuters",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.67,
      latitude: 50.55,
      availableFrom: "2024-12-28T00:00:00.000Z",
    ...
    },
    {
      ...
      description:
        "Spacious and bright apartment with large windows. Includes free gym access",
      numberOfRooms: 3,
      numberOfBeds: 2,
      numberOfBaths: 2,
      pets: true,
      ...
      longitude: 9.7,
      latitude: 50.57,
      availableFrom: "2025-03-05T00:00:00.000Z",
    ...
    },
    {
      ...
      description:
        "Trendy loft-style studio with high ceilings. Industrial design with metal fixtures",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.73,
      latitude: 50.52,
      availableFrom: "2025-02-18T00:00:00.000Z",
    ...
    },
    {
      id: 43,
      creatorId: 1,
      title: "Luxury 2-Room Apartment",
      description:
        "Premium apartment with floor-to-ceiling windows. Located in a high-end complex",
      numberOfRooms: 2,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.74,
      latitude: 50.48,
      availableFrom: "2025-02-25T00:00:00.000Z",
    ...
    },
    {
      id: 44,
      creatorId: 2,
      title: "Simple Studio with Balcony",
      description:
        "A small yet practical studio with a private balcony. Peaceful residential area",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
    ...
    },
    {
      ...
      description:
        "4-room apartment suitable for families. Includes parking spot",
      numberOfRooms: 4,
      numberOfBeds: 3,
      numberOfBaths: 2,
      pets: true,
      ...
      longitude: 9.76,
      latitude: 50.56,
      availableFrom: "2025-04-10T00:00:00.000Z",
    ...
    },
    {
      id: 46,
      creatorId: 1,
      title: "Exclusive High-Rise Studio",
      description:
        "A well-lit studio on a high floor with city views. Top floor, high ceilings",
      numberOfRooms: 1,
      numberOfBeds: 1,
      numberOfBaths: 1,
      pets: false,
      ...
      longitude: 9.77,
      latitude: 50.51,
      availableFrom: "2025-02-08T00:00:00.000Z",
